...
import com.spring.microservice.service.impl.TourRatingServiceImpl;
...
/**
 * {@link TourRatingService} unit test.
 */
...
public class TourRatingServiceTest {
    ...
    @InjectMocks
    private TourRatingService service = new TourRatingServiceImpl(tourRatingRepositoryMock, tourRepositoryMock);
    ...
    public void lookupRatingById() {
        ...
        assertThat(service.lookupRatingById(TOUR_RATING_ID).orElseThrow(RuntimeException::new), is(tourRatingMock));
    }
