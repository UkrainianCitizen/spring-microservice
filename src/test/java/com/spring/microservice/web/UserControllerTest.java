...
public class UserControllerTest {
    ...
    @Test
    public void signin() {
        restTemplate.postForEntity("/users/signin",
                new LoginRequest("admin", "myPass"), Void.class);
    ...
    public void signup() {
        ...
        assertThat(Objects.requireNonNull(response.getBody()).getUsername(), is(user.getUsername()));
    ...
    public void getAllUsers() {
        ...
        assertThat(response.getStatusCode().value(), is(200));
        assertThat(Objects.requireNonNull(response.getBody()).get(0).getUsername(), is(user.getUsername()));
    }
}